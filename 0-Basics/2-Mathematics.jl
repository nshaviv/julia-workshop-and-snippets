...
b = 2; c=3   # You can write multiple statements in one line
    d = 5 +
  6 + 7    # If a sentence doesn't end, it can split over lines      
x = a+b+sin(c);
y = rand() > 0.5 ? a : b^2   # Ternary operator
...
v .* v # elementwise multiplication

v * v # Cannot multiply two vertical vectors 
v' * v # inner product
v * v' # outter product!
